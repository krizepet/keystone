/*global jQuery, moment, _, Keystone, alert, confirm, require112 */
jQuery(function($) {
	// Import
	...
	$('.btn-create-item').on('click', function (e) {
        console.log('create click', window.location.pathname)
        if (window.location.pathname == '/keystone/repairs') {
			setTimeout(function () {
				$('.create-buttonek').trigger('click')
			},10)
		}
	})
